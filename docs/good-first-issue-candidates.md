...
This document tracks curated GitHub issues that are ideal for newcomers. These issues are self-contained, well-scoped, and require minimal domain context to be successfully resolved.

Additional candidates can be proposed by repository contributors by referencing the labeling guidelines in `CONTRIBUTING.md`.
...
- **Why it fits**: High-value documentation cleanup. Accessible to anyone who has succeeded in setting up their local sandbox and can share standard instructions.

---

## What Makes an Issue a "Good First Issue"?

Refer to the criteria documented in [CONTRIBUTING.md](../CONTRIBUTING.md#issue-leveling-and-label-curation) under **Issue Leveling and Label Curation**.
