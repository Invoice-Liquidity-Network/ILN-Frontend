...
| #934  | Automated component-level checks for every status-page component   | Open     | No automated checks are documented for the Web App, API / Indexer, or Stellar RPC components                                                                    |
