...
export const TESTNET_USDC_ISSUER = process.env.NEXT_PUBLIC_TESTNET_USDC_ISSUER || "";
export const TESTNET_EURC_ISSUER = process.env.NEXT_PUBLIC_TESTNET_EURC_ISSUER || "";
